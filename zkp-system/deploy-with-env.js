...
async function deployContracts() {
    try {
        console.log('🚀 Deploying ZKP Contracts with Environment Variables...');
        ...
        if (!privateKey) {
            ...
            console.log('   node deploy-with-env.js');
            console.log('\n🔐 You can extract your private key using:');
            console.log('   - Online keystore decryption tools');
            console.log('   - geth account import command');
            console.log('   - Or use the keystore file directly with geth');
            return;
        }
