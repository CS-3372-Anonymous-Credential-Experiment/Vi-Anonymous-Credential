...
async function deployContracts() {
    try {
        console.log('🚀 Deploying ZKP Contracts with Pre-funded Account...');
        
        // Connect to local Ethereum node
        const provider = new ethers.providers.JsonRpcProvider('http://localhost:8545');
        
        // Use the pre-funded account that we know has 10,000 ETH
        // This is a special account for testing purposes
